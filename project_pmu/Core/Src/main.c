...
static void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.NominalSyncJumpWidth = 0x1;
  hfdcan1.Init.NominalTimeSeg1 = 0x3f;
  hfdcan1.Init.NominalTimeSeg2 = 0x10;
  hfdcan1.Init.DataPrescaler = 1;
  hfdcan1.Init.DataSyncJumpWidth = 0x1;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI_CS2_Pin|SPI_CS1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ADC_BAT_Pin ADC_CUR_Pin */
  GPIO_InitStruct.Pin = ADC_BAT_Pin|ADC_CUR_Pin;
