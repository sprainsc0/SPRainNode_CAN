 ...
 *
 * Source file: f:\SPRainCore\aircraft_h7\module\canard\dsdl\uavcan\equipment\ahrs\1003.RawIMU.uavcan
 */
...
#else
        CANARD_USE_FLOAT16_CAST tmpe_float = (CANARD_USE_FLOAT16_CAST)source->rate_gyro_latest;
#endif
...
#else
        CANARD_USE_FLOAT16_CAST tmpe_float = (CANARD_USE_FLOAT16_CAST)source->accelerometer_latest;
#endif
        canardEncodeScalar(msg_buf, offset, 16, (void*)&tmpe_float); // 32767
        offset += 16;
    }
